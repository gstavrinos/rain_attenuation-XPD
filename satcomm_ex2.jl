...
function init()
    ...
    # ----- Input 6 -----
    even = true # group4 is investigating vertical polarizations
    ...
    Ap_ang1 = calcAttenuation(percentage_of_time, regions_for_group4, p837, index_of_interest, frequency_range, elevation_angle1, es_height, even, φ, link_availability)

    Ap_ang2 = calcAttenuation(percentage_of_time, regions_for_group4, p837, index_of_interest, frequency_range, elevation_angle2, es_height, even, φ, link_availability)
...
function initP838(vertical::Bool, frequency::Int64)
    p838_k = Dict{Int64, Float64}()
    p838_α = Dict{Int64, Float64}()
    if vertical
        p838_k[1] = 0.0000308
        p838_α[1] = 0.8592
        p838_k[2] = 0.0000998
    ...
    return p838_k[frequency], p838_α[frequency]
end
